...
function showSearchInputs(){
    ...
    SearchContainer.innerHTML = `
        <div class="row py-5">
            ...
            <div class="col-md-6">
                <input onkeyup="searchByFirstLetter(this.value)" maxlength="1" class="form-control bg-transparent border-top-0 border-start-0 border-end-0 text-white" type="text" placeholder="Search By First Litter...">
            </div>
        </div>
    `
    Meals.innerHTML = '';
